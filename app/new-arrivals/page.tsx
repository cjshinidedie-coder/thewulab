...
import { PRODUCTS, sortProducts, filterByNewArrivals, SortOption } from '@/lib/products';
...
export default function NewArrivalsPage() {
  ...
  const translations = {
    en: {
      ...
      subtitle: 'Discover our latest cosmic jewelry collection',
    },
    zh: {
      newArrivals: '新品上市',
      filter: '筛选',
      ...
      buyNow: '立即购买',
      noProducts: '暂无新品',
      subtitle: '发现我们最新的宇宙珠宝系列',
    },
  };

  const t = translations[language];

  const newProducts = filterByNewArrivals(PRODUCTS);
