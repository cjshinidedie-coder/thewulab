    ...
    <div>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <h1 className="font-serif tracking-widest">{t.heroTitle}</h1>
      ...
      <section className="section" >
        <h2 className="section-title font-serif tracking-wider">{t.bestSellers}</h2>
        ...
        <div className="discover-banner-merged">
          ...
          <div className="discover-overlay">
            <div className="discover-content-wrapper">
              <h2 className="discover-title font-serif tracking-wider">{t.discoverTitle}</h2>
      ...
      <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 px-4 md:px-8 my-10">
        {/* LEFT: NEW ARRIVALS */}
        <div className="relative w-full h-[350px] md:h-[400px] overflow-hidden bg-zinc-900">
          ...
          <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 z-20 flex flex-col items-start">
            <div className="banner-label font-serif tracking-wider">{t.newArrivals}</div>
        ...
        <div className="relative w-full h-[350px] md:h-[400px] overflow-hidden bg-zinc-900">
          ...
          <div className="absolute inset-0 bg-black/30 z-10"></div>
          <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 z-20 flex flex-col items-start">
            <div className="banner-label font-serif tracking-wider">GIFT</div>
      ...
      <section className="section">
        <h2 className="section-title font-serif tracking-wider">{t.shopByElement}</h2>
      ...
      <section className="reviews-section">
        <div className="reviews-container">
          <h2 className="reviews-title font-serif tracking-wider">{t.customerReviews}</h2>
      ...
      <section className="trust-section">
        <div className="trust-container">
          <div className="trust-item">
            <img src="/trust-hands.png" alt="Handmade with Love" className="trust-image" />
            <div className="trust-title">{t.handmadeWithLove}</div>
          </div>

          <div className="trust-item">
            <img src="/trust-lucky.png" alt="Brings Good Fortune" className="trust-image" />
            <div className="trust-title">{t.bringsGoodFortune}</div>
          </div>

          <div className="trust-item">
            <img src="/trust-secure.png" alt="Secure Payment" className="trust-image" />
            <div className="trust-title">{t.securePayment}</div>
          </div>

          <div className="trust-item">
            <img src="/trust-gift.png" alt="Perfect Gift Choice" className="trust-image" />
