 'use client';                                                                 
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-1.png" alt="Cosmic Turquoise Bracelet"
  className="product-image" />
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-2.png" alt="Imperial Jasper Bracelet"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-3.png" alt="Santa Maria Aquamarine"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-4.png" alt="Labradorite Bracelet"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-5.png" alt="Blue Aventurine Bracelet"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-6.png" alt="Tiger Eye - Hematite Pair"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-7.png" alt="Lava Bracelet"
  className="product-image" />
                  </div>
              ...
              <div className="swiper-slide">
                <div className="product-card">
                  <div className="product-image-wrapper">
                    <img src="/product-8.png" alt="Dragon Blood Jasper"
  className="product-image" />
                  </div>
